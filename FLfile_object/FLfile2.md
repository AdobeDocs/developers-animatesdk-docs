...
Method; determines whether a specified file exists. If you specify a folder and a filename, the folder must already exist. To create folders, see [FLfile.createFolder()](#!AdobeDocs/developers-animatesdk-docs/test/FLfile_object/FLfile1.md).
...
[FLfile.write()](#!AdobeDocs/developers-animatesdk-docs/test/FLfile_object/FLfile15.md)
