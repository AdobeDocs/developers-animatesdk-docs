...
The actionsPanel object, which represents the currently displayed Actions panel, is a property of the flash object (see [fl.actionsPanel](../flash_object_(fl)/fl.md)/fl.md)).
