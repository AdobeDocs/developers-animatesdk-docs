...
In Flash MX 2004, the value of instance.instanceType for an item added to the library using library.addNewItem("video") is "embedded\_video". In Flash 8 and later, the value is "video". See [library.addNewItem()](#!AdobeDocs/developers-animatesdk-docs/test/library_object/library1.md).
