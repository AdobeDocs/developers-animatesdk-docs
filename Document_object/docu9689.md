...
**rect** A rectangle object to set as selected. For information on the format of *rect*, see [document.addNewRectangle()](#!AdobeDocs/developers-animatesdk-docs/test/Document_object/docume10.md).
...
If you pass a value for *bContactSensitiveSelection*, it is valid only for this method and doesn’t affect the Contact Sensitive selection mode for the document (see [fl.contactSensitiveSelection](#!AdobeDocs/developers-animatesdk-docs/test/flash_object_(fl)/fl14.md)/fl14.md)
...
[document.getSelectionRect()](#!AdobeDocs/developers-animatesdk-docs/test/Document_object/docume84.md), [document.selection](#!AdobeDocs/developers-animatesdk-docs/test/Document_object/docum430.md), [document.setSelectionBounds()](#!AdobeDocs/developers-animatesdk-docs/test/Document_object/docu9658.md)
