...
[fl.findObjectInDocByName()](../flash_object_(fl)/fl27.md)/fl27.md) or [fl.findObjectInDocByType()](../flash_object_(fl)/fl28.md)/fl28.md).
...
[fl.findObjectInDocByName()](../flash_object_(fl)/fl27.md)/fl27.md), [fl.findObjectInDocByType()](../flash_object_(fl)/fl28.md)/fl28.md)
