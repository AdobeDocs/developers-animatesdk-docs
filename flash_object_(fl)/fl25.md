...
Method; lets you target a specific file by using its unique identifier (instead of its index value, for example). Use this method in conjunction with [document.id](#!AdobeDocs/developers-animatesdk-docs/master/Document_object/docume92.md).
...
[fl.findDocumentIndex()](#!AdobeDocs/developers-animatesdk-docs/master/flash_object_(fl)/fl26.md))
