...
Read-only property; an array of the file types in the MRU list that the Flash authoring tool manages. This array corresponds to the array in the [fl.mruRecentFileList](#!AdobeDocs/developers-animatesdk-docs/test/flash_object_(fl)/fl42.md)/fl42.md) property.
