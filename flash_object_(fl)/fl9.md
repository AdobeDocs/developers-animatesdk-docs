...
**documentObject** A [Document object](#!AdobeDocs/developers-animatesdk-docs/master/Document_object/document_summary.md). If *documentObject* refers to the active document, the Document window might not close until the script that calls this method finishes executing.
...
[fl.closeAll()](#!AdobeDocs/developers-animatesdk-docs/master/flash_object_(fl)/fl7.md)
